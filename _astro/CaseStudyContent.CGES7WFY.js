...
import{j as e}from"./jsx-runtime.D_zvdyIk.js";import{r as j}from"./index.DiEladB3.js";import{_ as re}from"./preload-helper.BlTxHScW.js";import{r as Pe}from"./index.Pl_XcmgS.js";function ke(t){const r=document.body;for(let d=t.parentElement;d&&d!==r;d=d.parentElement){const f=getComputedStyle(d).overflowY;if(f==="auto"||f==="scroll")return d}return null}const De=.06,xe=.0085,Ie=.006,Z=1.45,Re=8;function Be({modelUrl:t,poster:r,posterAlt:d,accent:f,yaw:w=0,exposure:i=1,orient:v}){const N=j.useRef(null),[k,L]=j.useState(!1),[s,p]=j.useState("poster"),[c,h]=j.useState(!1);j.useEffect(()=>{if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const l=N.current;if(!l)return;let x=!1;const S=()=>{x||L(!0)},a=()=>{const g=window;g.requestIdleCallback?g.requestIdleCallback(S,{timeout:1200}):window.setTimeout(S,200)},b=()=>{const g=(document.getAnimations?.()??[]).filter(n=>n.playState==="running"&&/^cs-(main|page)-in$/.test(n.animationName??""));g.length?Promise.allSettled(g.map(n=>n.finished)).then(a,a):a()},T=new IntersectionObserver(([g])=>{g.isIntersecting&&(T.disconnect(),b())},{root:ke(l),rootMargin:"400px 0px"});return T.observe(l),()=>{x=!0,T.disconnect()}},[]),j.useEffect(()=>{if(!k)return;const l=N.current;if(!l)return;let x=!1,S=null;return(async()=>{const[a,{GLTFLoader:b},{RoomEnvironment:T}]=await Promise.all([re(()=>import("./three.module.Bx43vjkH.js"),[]),re(()=>import("./GLTFLoader.BqdKpcjx.js"),__vite__mapDeps([0,1])),re(()=>import("./RoomEnvironment.Ct7rVCVU.js"),__vite__mapDeps([2,1]))]);if(x)return;let g;try{if(g=new a.WebGLRenderer({antialias:!0,alpha:!0}),!g.getContext())throw new Error("no webgl context")}catch(y){console.warn("CaseStudyStage: WebGL unavailable, keeping poster",y),p("failed");return}g.setPixelRatio(Math.min(window.devicePixelRatio,2)),g.toneMapping=a.ACESFilmicToneMapping,g.toneMappingExposure=.82*i,g.outputColorSpace=a.SRGBColorSpace,g.setSize(l.clientWidth,l.clientHeight),l.appendChild(g.domElement);const n=g.domElement;n.style.width="100%",n.style.height="100%",n.style.display="block",n.style.touchAction="pan-y";const u=new a.Scene,A=new a.PerspectiveCamera(38,l.clientWidth/l.clientHeight,.1,100);A.position.set(0,0,5.4);const P=new a.PMREMGenerator(g),z=P.fromScene(new T,.04).texture;u.environment=z,u.environmentIntensity=.55;const M=new a.Color(f),H=M.clone().lerp(new a.Color("#ffffff"),.55),B=new a.DirectionalLight(16777215,.5);B.position.set(0,3,5);const V=new a.DirectionalLight(M,1);V.position.set(-5,1.5,-3.5);const _=new a.DirectionalLight(H,.7);_.position.set(4.5,2,3),u.add(B,V,_);const E=new a.Group,C=new a.Group;C.rotation.y=w,E.add(C),u.add(E);const K=(y,q)=>{const R=new a.Box3().setFromObject(y),O=R.getSize(new a.Vector3),U=R.getCenter(new a.Vector3),Ee=Math.max(O.x,O.y,O.z)||1,ye=q/Ee;y.scale.setScalar(ye),y.position.copy(U).multiplyScalar(-ye)};new b().load(t,y=>{if(x)return;const q=y.scene,R=new a.Group;v&&R.rotation.set(v[0],v[1],v[2]),R.add(q),K(R,2.8);const O=()=>{x||(C.add(R),p("ready"))};g.compileAsync(R,A,u).then(O,O)},void 0,y=>{console.warn("CaseStudyStage: GLB failed to load, keeping poster",y),p("failed")});let D=!1,I=!1,G=0,$=0,ne=0,le=0,F=0;const ze=y=>y<-Z?-Z:y>Z?Z:y,ce=y=>{y.pointerType==="mouse"&&y.button!==0||(D=!0,I=y.pointerType!=="touch",G=ne=y.clientX,$=le=y.clientY,F=0,I&&n.setPointerCapture?.(y.pointerId),h(!0))},de=y=>{if(!D)return;if(!I){const O=y.clientX-ne,U=y.clientY-le;if(Math.hypot(O,U)<Re)return;if(Math.abs(O)<=Math.abs(U)){D=!1,h(!1);return}I=!0,n.setPointerCapture?.(y.pointerId)}const q=y.clientX-G,R=y.clientY-$;G=y.clientX,$=y.clientY,C.rotation.y+=q*xe,E.rotation.x=ze(E.rotation.x+R*Ie),F=F*.6+q*xe*.4},X=()=>{D&&(D=!1,I=!1,h(!1))};n.addEventListener("pointerdown",ce),n.addEventListener("pointermove",de),n.addEventListener("pointerup",X),n.addEventListener("pointercancel",X);let Y=!1;const he=y=>{y.pointerType==="mouse"&&(Y=!0)},pe=()=>{Y=!1};l.addEventListener("pointerenter",he),l.addEventListener("pointerleave",pe);const me=new a.Clock;let Q=0,ee=!1;const Ce=()=>{const y=Math.min(me.getDelta(),.05);if(!D){const q=Y?0:De*y;F+=(q-F)*(Y?.09:.03),Y&&Math.abs(F)<1e-5&&(F=0),C.rotation.y+=F}g.render(u,A)},ge=()=>{Ce(),Q=requestAnimationFrame(ge)},He=()=>{ee||(ee=!0,me.start(),Q=requestAnimationFrame(ge))},ue=()=>{ee=!1,cancelAnimationFrame(Q)};let fe=!0;const te=()=>{fe&&!document.hidden?He():ue()},be=new IntersectionObserver(([y])=>{fe=y.isIntersecting,te()},{root:ke(l),threshold:0});be.observe(l);const we=()=>te();document.addEventListener("visibilitychange",we);const ae=()=>{!l.clientWidth||!l.clientHeight||(A.aspect=l.clientWidth/l.clientHeight,A.updateProjectionMatrix(),g.setSize(l.clientWidth,l.clientHeight))};window.addEventListener("resize",ae);const ve=new ResizeObserver(ae);ve.observe(l),te(),S=()=>{ue(),be.disconnect(),ve.disconnect(),document.removeEventListener("visibilitychange",we),window.removeEventListener("resize",ae),n.removeEventListener("pointerdown",ce),n.removeEventListener("pointermove",de),n.removeEventListener("pointerup",X),n.removeEventListener("pointercancel",X),l.removeEventListener("pointerenter",he),l.removeEventListener("pointerleave",pe),z.dispose(),P.dispose(),g.dispose(),n.parentNode===l&&l.removeChild(n)}})(),()=>{x=!0,S?.()}},[k,t,f,w,i,v]);const m=s!=="ready";return e.jsxs("div",{className:"cs-stage",style:{cursor:s==="ready"?c?"grabbing":"grab":"default"},children:[e.jsx("div",{ref:N,className:"cs-stage-mount","aria-hidden":s==="ready"?void 0:!0}),e.jsx("img",{src:r,alt:d,draggable:!1,className:"cs-stage-poster",style:{opacity:m?1:0},loading:"lazy"}),s==="ready"&&e.jsxs("span",{className:"cs-stage-hint",style:{color:f},children:[e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:e.jsx("path",{d:"M12 4v16M4 12h16M12 4l-3 3M12 4l3 3M12 20l-3-3M12 20l3-3M4 12l3-3M4 12l3 3M20 12l-3-3M20 12l-3 3"})}),"Drag to rotate"]}),e.jsx("style",{children:`
        .cs-stage {
          position: relative;
          width: 100%;
          height: 100%;
      ...
      `})]})}const Oe=.26,Ge=.2,je=30,Se=17,Te=.93,Fe=.045,Me=3;function qe({hero:t,heroAlt:r,backdrop:d,accent:f}){const w=j.useRef(null),i=j.useRef(null),[v,N]=j.useState(!1);return j.useEffect(()=>{const k=w.current,L=i.current;if(!k||!L)return;const s=window.matchMedia("(prefers-reduced-motion: reduce)").matches;let p=0,c=0,h=0,m=0,l=!1,x=!1,S=0,a=0,b=0;const T=(M,H)=>M<-H?-H:M>H?H:M,g=()=>{L.style.transform=`perspective(1100px) rotateX(${c.toFixed(3)}deg) rotateY(${p.toFixed(3)}deg)`},n=()=>{if(b=0,l)return;if(Math.abs(h)>.05||Math.abs(m)>.05)p=T(p+h,je),c=T(c+m,Se),h*=Te,m*=Te;else{h=0,m=0;const H=s?.25:Fe;if(p+=(0-p)*H,c+=(0-c)*H,Math.abs(p)<.04&&Math.abs(c)<.04){p=0,c=0,g();return}}g(),b=requestAnimationFrame(n)},u=()=>{!b&&!l&&(b=requestAnimationFrame(n))},A=M=>{M.pointerType==="mouse"&&M.button!==0||(x=!0,l=!1,S=M.clientX,a=M.clientY,h=0,m=0,b&&(cancelAnimationFrame(b),b=0))},P=M=>{if(!x)return;const H=M.clientX-S,B=M.clientY-a;if(!l){if(Math.abs(H)<Me&&Math.abs(B)<Me)return;if(M.pointerType!=="mouse"&&Math.abs(B)>Math.abs(H)){x=!1;return}l=!0,N(!0),k.classList.add("csis-dragging"),k.setPointerCapture?.(M.pointerId)}S=M.clientX,a=M.clientY,h=H*Oe,m=B*Ge,p=T(p+h,je),c=T(c+m,Se),g()},z=M=>{!x&&!l||(x=!1,l&&(l=!1,k.classList.remove("csis-dragging"),k.releasePointerCapture?.(M.pointerId),s&&(h=0,m=0)),u())};return k.addEventListener("pointerdown",A),k.addEventListener("pointermove",P),k.addEventListener("pointerup",z),k.addEventListener("pointercancel",z),()=>{k.removeEventListener("pointerdown",A),k.removeEventListener("pointermove",P),k.removeEventListener("pointerup",z),k.removeEventListener("pointercancel",z),b&&cancelAnimationFrame(b)}},[]),e.jsxs("div",{ref:w,className:"csis",children:[e.jsx("img",{src:d,alt:"","aria-hidden":"true",className:"csis-backdrop",draggable:!1}),e.jsx("div",{className:"csis-scrim","aria-hidden":"true"}),e.jsx("div",{ref:i,className:"csis-tilt",children:e.jsx("img",{src:t,alt:r,className:"csis-hero",draggable:!1})}),!v&&e.jsxs("span",{className:"csis-hint",style:{color:f},children:[e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:e.jsx("path",{d:"M4 12h16M4 12l4-4M4 12l4 4M20 12l-4-4M20 12l-4 4"})}),"Drag to turn"]}),e.jsx("style",{children:`
        .csis {
          position: relative;
          width: 100%;
          height: 100%;
      ...
      `})]})}function $e({src:t,alt:r}){return e.jsxs("div",{className:"csps",children:[e.jsx("img",{src:t,alt:r,className:"csps-art",draggable:!1}),e.jsx("div",{className:"csps-vignette","aria-hidden":"true"}),e.jsx("style",{children:`
        .csps {
          position: relative;
          width: 100%;
          height: 100%;
      ...
      `})]})}function Ne(t){const r=document.body;for(let d=t.parentElement;d&&d!==r;d=d.parentElement){const f=getComputedStyle(d).overflowY;if(f==="auto"||f==="scroll")return d}return null}const Ye=t=>1-(1-t)*(1-t),We=t=>t<0?0:t>1?1:t;function Ve({data:t}){const r=j.useRef(null),d=j.useRef([]),[f,w]=j.useState(!1),[i,v]=j.useState(null),[N,k]=j.useState(null),L=i??N,s=t.map.pins.find(a=>a.key===L)??null,{canvas:p,layers:c}=t.parallax,[h,m]=p;j.useEffect(()=>{const a=r.current;if(!a||window.matchMedia("(prefers-reduced-motion: reduce)").matches||!window.matchMedia("(min-width: 768px)").matches)return;let b=!1;const T=new IntersectionObserver(([g])=>{if(!g.isIntersecting)return;T.disconnect();const n=()=>{b||w(!0)},u=(document.getAnimations?.()??[]).filter(A=>A.playState==="running"&&/^cs-(main|page)-in$/.test(A.animationName??""));u.length?Promise.allSettled(u.map(A=>A.finished)).then(n,n):n()},{root:Ne(a),rootMargin:"300px 0px"});return T.observe(a),()=>{b=!0,T.disconnect()}},[]),j.useEffect(()=>{if(!f)return;const a=r.current;if(!a)return;const b=Ne(a),T=performance.now();let g=T,n=0;const u=c.map(z=>z.intro[0]),A=z=>{const M=Math.min((z-g)/1e3,.1);g=z;const H=a.getBoundingClientRect(),B=b?b.clientHeight:window.innerHeight,V=b?H.top-b.getBoundingClientRect().top:H.top,_=We((B-V)/(B+H.height));for(let E=0;E<c.length;E++){const C=c[E],K=d.current[E];if(!K)continue;const D=(z-T)/1e3-C.delay;let I;if(D<C.dur){const G=D<=0?0:Ye(D/C.dur);I=C.intro[0]+(C.intro[1]-C.intro[0])*G,u[E]=I}else{const G=C.scrollTo===void 0?C.intro[1]:C.intro[1]+(C.scrollTo-C.intro[1])*_,$=C.scrub??0;u[E]=$>0?u[E]+(G-u[E])*(1-Math.exp(-M/$)):G,I=u[E]}K.style.transform=`translate3d(0, ${I.toFixed(3)}%, 0)`}n=requestAnimationFrame(A)},P=new IntersectionObserver(([z])=>{z.isIntersecting?n||(g=performance.now(),n=requestAnimationFrame(A)):n&&(cancelAnimationFrame(n),n=0)},{root:b,threshold:0});return P.observe(a),()=>{P.disconnect(),n&&cancelAnimationFrame(n)}},[f,c]);const[l,x]=t.map.canvas,S=(a,b)=>`${(a/b*100).toFixed(4)}%`;return e.jsxs("section",{className:"csm","aria-labelledby":"csm-head",children:[e.jsxs("div",{className:"cs-section-head",children:[e.jsx("p",{className:"cs-eyebrow",id:"csm-head",children:t.eyebrow}),e.jsx("p",{className:"cs-stage-note",children:t.note})]}),e.jsxs("div",{className:"csm-inner",children:[e.jsx("p",{className:"csm-lede",children:t.lede}),e.jsxs("figure",{className:"csm-fig",children:[e.jsx("div",{className:"csm-stage",ref:r,style:{aspectRatio:`${h} / ${m}`},"aria-hidden":"true",children:c.map((a,b)=>e.jsx("img",{ref:T=>{d.current[b]=T},className:"csm-layer",src:a.src,alt:"",loading:"lazy",decoding:"async",draggable:!1,style:{left:S(a.x,h),top:S(a.y,m),width:S(a.w,h),transform:`translate3d(0, ${a.intro[1]}%, 0)`}},a.key))}),e.jsx("figcaption",{className:"csm-cap",children:t.parallax.caption})]}),e.jsxs("figure",{className:"csm-fig",children:[e.jsxs("div",{className:"csm-map",style:{aspectRatio:`${l} / ${x}`},children:[e.jsx("img",{className:"csm-map-art",src:t.map.src,alt:t.map.alt,loading:"lazy",decoding:"async",draggable:!1}),t.map.pins.map(a=>e.jsx("button",{type:"button",className:"csm-pin","data-on":L===a.key?"":void 0,"aria-pressed":N===a.key,"aria-label":`${a.label} pin${a.unbuilt?", designed and never built":""}`,style:{left:S(a.x,l),top:S(a.y,x),width:S(a.w,l),height:S(a.h,x)},onMouseEnter:()=>v(a.key),onMouseLeave:()=>v(null),onFocus:()=>v(a.key),onBlur:()=>v(null),onClick:()=>k(b=>b===a.key?null:a.key),children:e.jsx("img",{className:"csm-pin-art",src:a.hover,alt:"",loading:"lazy",decoding:"async",draggable:!1})},a.key))]}),e.jsx("p",{className:"csm-readout","aria-live":"polite",children:s?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"csm-readout-k",children:s.label}),s.note]}):e.jsx("span",{className:"csm-readout-idle",children:t.map.idle})}),e.jsx("ul",{className:"csm-pinlist",children:t.map.pins.map(a=>e.jsxs("li",{className:"csm-row",children:[e.jsx("img",{className:"csm-pinlist-art",src:a.hover,alt:`${a.label} pin, hover state`,loading:"lazy",decoding:"async"}),e.jsx("span",{className:"csm-row-d",children:a.note})]},a.key))}),e.jsx("figcaption",{className:"csm-cap",children:t.map.caption}),e.jsx("p",{className:"csm-shipped",children:t.map.shipped})]}),e.jsxs("div",{className:"csm-block",children:[e.jsx("h3",{className:"cs-eyebrow",children:"Client direction"}),e.jsx("ul",{className:"csm-rows csm-rows-q",children:t.direction.map(a=>e.jsxs("li",{className:"csm-row csm-row-q",children:[e.jsx("blockquote",{className:"csm-q",children:a.quote}),e.jsxs("p",{className:"csm-attr",children:[a.author,e.jsx("span",{className:"csm-attr-date",children:a.date})]}),e.jsx("p",{className:"csm-out",children:a.outcome})]},a.quote))}),e.jsx("p",{className:"csm-foot",children:t.directionNote}),e.jsx("ul",{className:"csm-rows csm-rows-h",children:t.handoff.map(a=>e.jsxs("li",{className:"csm-row csm-row-h",children:[e.jsx("span",{className:"csm-hnote",children:a.note}),e.jsx("span",{className:"csm-row-d",children:a.detail})]},a.note))})]})]}),e.jsx("style",{children:`
      ...
      `})]})}const _e=48;function Ke({items:t,index:r,accent:d,onIndex:f,onClose:w}){const i=j.useRef(null),v=j.useRef(null),N=t[r],k=j.useCallback(s=>{t.length<2||f((r+s+t.length)%t.length)},[r,t.length,f]);if(j.useEffect(()=>{const s=p=>{p.key==="Escape"?(p.preventDefault(),p.stopPropagation(),w()):p.key==="ArrowRight"?k(1):p.key==="ArrowLeft"&&k(-1)};return window.addEventListener("keydown",s,!0),()=>window.removeEventListener("keydown",s,!0)},[k,w]),j.useEffect(()=>{const s=window.__lenis,p=s?.isStopped===!0;p||s?.stop?.();const c=document.documentElement,h=c.style.overflow,m=document.body.style.overflow;c.style.overflow="hidden",document.body.style.overflow="hidden";const l=document.querySelector(".cso-scroll"),x=l?.style.overflowY??null;return l&&(l.style.overflowY="hidden"),()=>{c.style.overflow=h,document.body.style.overflow=m,l&&(l.style.overflowY=x??""),p||s?.start?.()}},[]),j.useEffect(()=>{const s=document.activeElement;return i.current?.focus(),()=>s?.focus?.()},[]),!N)return null;const L=e.jsxs("div",{className:"csl",role:"dialog","aria-modal":"true","aria-label":`${N.alt}${t.length>1?`, image ${r+1} of ${t.length}`:""}`,style:{"--csl-accent":d},"data-lenis-prevent":!0,onClick:w,onTouchStart:s=>{const p=s.touches[0];v.current={x:p.clientX,y:p.clientY}},onTouchEnd:s=>{const p=v.current;if(v.current=null,!p)return;const c=s.changedTouches[0],h=c.clientX-p.x,m=c.clientY-p.y;Math.abs(h)>_e&&Math.abs(h)>Math.abs(m)*1.5&&k(h<0?1:-1)},children:[e.jsx("button",{ref:i,className:"csl-x",onClick:w,"aria-label":"Close image",children:e.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round","aria-hidden":"true",children:e.jsx("path",{d:"M5 5l14 14M19 5L5 19"})})}),t.length>1&&e.jsxs("span",{className:"csl-count","aria-hidden":"true",children:[String(r+1).padStart(2,"0")," / ",String(t.length).padStart(2,"0")]}),t.length>1&&e.jsxs(e.Fragment,{children:[e.jsx("button",{className:"csl-nav csl-prev","aria-label":"Previous image",onClick:s=>{s.stopPropagation(),k(-1)},children:e.jsx("svg",{width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:e.jsx("path",{d:"M15 5l-7 7 7 7"})})}),e.jsx("button",{className:"csl-nav csl-next","aria-label":"Next image",onClick:s=>{s.stopPropagation(),k(1)},children:e.jsx("svg",{width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:e.jsx("path",{d:"M9 5l7 7-7 7"})})})]}),e.jsxs("figure",{className:"csl-fig",onClick:s=>s.stopPropagation(),children:[e.jsx("img",{className:"csl-img",src:N.src,alt:N.alt,decoding:"async"},N.src),e.jsx("figcaption",{className:"csl-cap",children:N.caption??N.alt})]}),e.jsx("style",{children:`
        .csl {
          position: fixed;
          inset: 0;
          z-index: 400;
      ...
      `})]});return Pe.createPortal(L,document.body)}const Xe=t=>{const r=[];let d=[];for(const f of t)f.kind==="tile"?d.push(f):(d.length&&r.push({type:"grid",tiles:d}),d=[],r.push({type:"divider",divider:f}));return d.length&&r.push({type:"grid",tiles:d}),r},Ue=t=>{const r=t.col>=3?2:1,d=t.rowM??Math.max(2,Math.round(t.row*.75));return{"--c":t.col,"--r":t.row,"--cm":r,"--rm":d,...t.pos?{"--pos":t.pos}:{}}},Ze=t=>["cs-tile",`cs-tile-${t.tile??"plain"}`,`cs-pad-${t.pad??"std"}`,t.fit==="cover"?"cs-fit-cover":"cs-fit-contain"].join(" ");function Je({gallery:t,accent:r,glow:d,resetKey:f,eyebrow:w="The Work",standalone:i=!1}){const[v,N]=j.useState(null);j.useEffect(()=>N(null),[f]);const k=Xe(t),L=t.map(c=>c.kind==="tile"?{src:c.src,alt:c.alt,caption:c.caption}:{src:c.src,alt:c.alt}),s=new Map(L.map((c,h)=>[c.src,h])),p=i?{"--cs-accent":r,"--cs-glow":d??"transparent"}:void 0;return e.jsxs(e.Fragment,{children:[e.jsxs("section",{className:"cs-gallery","aria-label":"Project gallery",style:p,children:[w&&e.jsx("div",{className:"cs-section-head",children:e.jsx("p",{className:"cs-eyebrow",children:w})}),k.map((c,h)=>c.type==="grid"?e.jsx("div",{className:"cs-grid",children:c.tiles.map(m=>e.jsxs("figure",{className:Ze(m),style:Ue(m),children:[e.jsx("button",{type:"button",className:"cs-tile-open",onClick:()=>N(s.get(m.src)??0),children:e.jsx("img",{src:m.src,alt:m.alt,loading:"lazy",decoding:"async"})}),m.caption&&e.jsx("figcaption",{className:"cs-cap",children:m.caption})]},m.src))},h):e.jsx("div",{className:"cs-band",children:e.jsx("button",{type:"button",className:"cs-tile-open",onClick:()=>N(s.get(c.divider.src)??0),children:e.jsx("img",{src:c.divider.src,alt:c.divider.alt,loading:"lazy",decoding:"async"})})},h))]}),v!==null&&e.jsx(Ke,{items:L,index:v,accent:r,onIndex:N,onClose:()=>N(null)}),e.jsx("style",{children:`
        /* ═══ Gallery ═══ */
