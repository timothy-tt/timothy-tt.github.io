...
import{j as e}from"./jsx-runtime.D_zvdyIk.js";import{r as j}from"./index.DiEladB3.js";import{_ as re}from"./preload-helper.BlTxHScW.js";import{r as Pe}from"./index.Pl_XcmgS.js";function ke(t){const o=document.body;for(let d=t.parentElement;d&&d!==o;d=d.parentElement){const f=getComputedStyle(d).overflowY;if(f==="auto"||f==="scroll")return d}return null}const De=.06,xe=.0085,Be=.006,Z=1.45,Re=8;function Ie({modelUrl:t,poster:o,posterAlt:d,accent:f,yaw:w=0,exposure:i=1,orient:v}){const A=j.useRef(null),[k,E]=j.useState(!1),[s,p]=j.useState("poster"),[c,h]=j.useState(!1);j.useEffect(()=>{if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const l=A.current;if(!l)return;let x=!1;const T=()=>{x||E(!0)},r=()=>{const g=window;g.requestIdleCallback?g.requestIdleCallback(T,{timeout:1200}):window.setTimeout(T,200)},b=()=>{const g=(document.getAnimations?.()??[]).filter(n=>n.playState==="running"&&/^cs-(main|page)-in$/.test(n.animationName??""));g.length?Promise.allSettled(g.map(n=>n.finished)).then(r,r):r()},S=new IntersectionObserver(([g])=>{g.isIntersecting&&(S.disconnect(),b())},{root:ke(l),rootMargin:"400px 0px"});return S.observe(l),()=>{x=!0,S.disconnect()}},[]),j.useEffect(()=>{if(!k)return;const l=A.current;if(!l)return;let x=!1,T=null;return(async()=>{const[r,{GLTFLoader:b},{RoomEnvironment:S}]=await Promise.all([re(()=>import("./three.module.Bx43vjkH.js"),[]),re(()=>import("./GLTFLoader.BqdKpcjx.js"),__vite__mapDeps([0,1])),re(()=>import("./RoomEnvironment.Ct7rVCVU.js"),__vite__mapDeps([2,1]))]);if(x)return;let g;try{if(g=new r.WebGLRenderer({antialias:!0,alpha:!0}),!g.getContext())throw new Error("no webgl context")}catch(y){console.warn("CaseStudyStage: WebGL unavailable, keeping poster",y),p("failed");return}g.setPixelRatio(Math.min(window.devicePixelRatio,2)),g.toneMapping=r.ACESFilmicToneMapping,g.toneMappingExposure=.82*i,g.outputColorSpace=r.SRGBColorSpace,g.setSize(l.clientWidth,l.clientHeight),l.appendChild(g.domElement);const n=g.domElement;n.style.width="100%",n.style.height="100%",n.style.display="block",n.style.touchAction="pan-y";const u=new r.Scene,N=new r.PerspectiveCamera(38,l.clientWidth/l.clientHeight,.1,100);N.position.set(0,0,5.4);const P=new r.PMREMGenerator(g),L=P.fromScene(new S,.04).texture;u.environment=L,u.environmentIntensity=.55;const M=new r.Color(f),C=M.clone().lerp(new r.Color("#ffffff"),.55),I=new r.DirectionalLight(16777215,.5);I.position.set(0,3,5);const V=new r.DirectionalLight(M,1);V.position.set(-5,1.5,-3.5);const _=new r.DirectionalLight(C,.7);_.position.set(4.5,2,3),u.add(I,V,_);const H=new r.Group,z=new r.Group;z.rotation.y=w,H.add(z),u.add(H);const K=(y,q)=>{const R=new r.Box3().setFromObject(y),G=R.getSize(new r.Vector3),U=R.getCenter(new r.Vector3),He=Math.max(G.x,G.y,G.z)||1,ye=q/He;y.scale.setScalar(ye),y.position.copy(U).multiplyScalar(-ye)};new b().load(t,y=>{if(x)return;const q=y.scene,R=new r.Group;v&&R.rotation.set(v[0],v[1],v[2]),R.add(q),K(R,2.8);const G=()=>{x||(z.add(R),p("ready"))};g.compileAsync(R,N,u).then(G,G)},void 0,y=>{console.warn("CaseStudyStage: GLB failed to load, keeping poster",y),p("failed")});let D=!1,B=!1,O=0,$=0,ne=0,le=0,F=0;const Le=y=>y<-Z?-Z:y>Z?Z:y,ce=y=>{y.pointerType==="mouse"&&y.button!==0||(D=!0,B=y.pointerType!=="touch",O=ne=y.clientX,$=le=y.clientY,F=0,B&&n.setPointerCapture?.(y.pointerId),h(!0))},de=y=>{if(!D)return;if(!B){const G=y.clientX-ne,U=y.clientY-le;if(Math.hypot(G,U)<Re)return;if(Math.abs(G)<=Math.abs(U)){D=!1,h(!1);return}B=!0,n.setPointerCapture?.(y.pointerId)}const q=y.clientX-O,R=y.clientY-$;O=y.clientX,$=y.clientY,z.rotation.y+=q*xe,H.rotation.x=Le(H.rotation.x+R*Be),F=F*.6+q*xe*.4},X=()=>{D&&(D=!1,B=!1,h(!1))};n.addEventListener("pointerdown",ce),n.addEventListener("pointermove",de),n.addEventListener("pointerup",X),n.addEventListener("pointercancel",X);let Y=!1;const he=y=>{y.pointerType==="mouse"&&(Y=!0)},pe=()=>{Y=!1};l.addEventListener("pointerenter",he),l.addEventListener("pointerleave",pe);const me=new r.Clock;let Q=0,ee=!1;const ze=()=>{const y=Math.min(me.getDelta(),.05);if(!D){const q=Y?0:De*y;F+=(q-F)*(Y?.09:.03),Y&&Math.abs(F)<1e-5&&(F=0),z.rotation.y+=F}g.render(u,N)},ge=()=>{ze(),Q=requestAnimationFrame(ge)},Ce=()=>{ee||(ee=!0,me.start(),Q=requestAnimationFrame(ge))},ue=()=>{ee=!1,cancelAnimationFrame(Q)};let fe=!0;const te=()=>{fe&&!document.hidden?Ce():ue()},be=new IntersectionObserver(([y])=>{fe=y.isIntersecting,te()},{root:ke(l),threshold:0});be.observe(l);const we=()=>te();document.addEventListener("visibilitychange",we);const ae=()=>{!l.clientWidth||!l.clientHeight||(N.aspect=l.clientWidth/l.clientHeight,N.updateProjectionMatrix(),g.setSize(l.clientWidth,l.clientHeight))};window.addEventListener("resize",ae);const ve=new ResizeObserver(ae);ve.observe(l),te(),T=()=>{ue(),be.disconnect(),ve.disconnect(),document.removeEventListener("visibilitychange",we),window.removeEventListener("resize",ae),n.removeEventListener("pointerdown",ce),n.removeEventListener("pointermove",de),n.removeEventListener("pointerup",X),n.removeEventListener("pointercancel",X),l.removeEventListener("pointerenter",he),l.removeEventListener("pointerleave",pe),L.dispose(),P.dispose(),g.dispose(),n.parentNode===l&&l.removeChild(n)}})(),()=>{x=!0,T?.()}},[k,t,f,w,i,v]);const m=s!=="ready";return e.jsxs("div",{className:"cs-stage",style:{cursor:s==="ready"?c?"grabbing":"grab":"default"},children:[e.jsx("div",{ref:A,className:"cs-stage-mount","aria-hidden":s==="ready"?void 0:!0}),e.jsx("img",{src:o,alt:d,draggable:!1,className:"cs-stage-poster",style:{opacity:m?1:0},loading:"lazy"}),s==="ready"&&e.jsxs("span",{className:"cs-stage-hint",style:{color:f},children:[e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:e.jsx("path",{d:"M12 4v16M4 12h16M12 4l-3 3M12 4l3 3M12 20l-3-3M12 20l3-3M4 12l3-3M4 12l3 3M20 12l-3-3M20 12l-3 3"})}),"Drag to rotate"]}),e.jsx("style",{children:`
        .cs-stage {
          position: relative;
          width: 100%;
          height: 100%;
      ...
      `})]})}const Ge=.26,Oe=.2,je=30,Te=17,Se=.93,Fe=.045,Me=3;function qe({hero:t,heroAlt:o,backdrop:d,accent:f}){const w=j.useRef(null),i=j.useRef(null),[v,A]=j.useState(!1);return j.useEffect(()=>{const k=w.current,E=i.current;if(!k||!E)return;const s=window.matchMedia("(prefers-reduced-motion: reduce)").matches;let p=0,c=0,h=0,m=0,l=!1,x=!1,T=0,r=0,b=0;const S=(M,C)=>M<-C?-C:M>C?C:M,g=()=>{E.style.transform=`perspective(1100px) rotateX(${c.toFixed(3)}deg) rotateY(${p.toFixed(3)}deg)`},n=()=>{if(b=0,l)return;if(Math.abs(h)>.05||Math.abs(m)>.05)p=S(p+h,je),c=S(c+m,Te),h*=Se,m*=Se;else{h=0,m=0;const C=s?.25:Fe;if(p+=(0-p)*C,c+=(0-c)*C,Math.abs(p)<.04&&Math.abs(c)<.04){p=0,c=0,g();return}}g(),b=requestAnimationFrame(n)},u=()=>{!b&&!l&&(b=requestAnimationFrame(n))},N=M=>{M.pointerType==="mouse"&&M.button!==0||(x=!0,l=!1,T=M.clientX,r=M.clientY,h=0,m=0,b&&(cancelAnimationFrame(b),b=0))},P=M=>{if(!x)return;const C=M.clientX-T,I=M.clientY-r;if(!l){if(Math.abs(C)<Me&&Math.abs(I)<Me)return;if(M.pointerType!=="mouse"&&Math.abs(I)>Math.abs(C)){x=!1;return}l=!0,A(!0),k.classList.add("csis-dragging"),k.setPointerCapture?.(M.pointerId)}T=M.clientX,r=M.clientY,h=C*Ge,m=I*Oe,p=S(p+h,je),c=S(c+m,Te),g()},L=M=>{!x&&!l||(x=!1,l&&(l=!1,k.classList.remove("csis-dragging"),k.releasePointerCapture?.(M.pointerId),s&&(h=0,m=0)),u())};return k.addEventListener("pointerdown",N),k.addEventListener("pointermove",P),k.addEventListener("pointerup",L),k.addEventListener("pointercancel",L),()=>{k.removeEventListener("pointerdown",N),k.removeEventListener("pointermove",P),k.removeEventListener("pointerup",L),k.removeEventListener("pointercancel",L),b&&cancelAnimationFrame(b)}},[]),e.jsxs("div",{ref:w,className:"csis",children:[e.jsx("img",{src:d,alt:"","aria-hidden":"true",className:"csis-backdrop",draggable:!1}),e.jsx("div",{className:"csis-scrim","aria-hidden":"true"}),e.jsx("div",{ref:i,className:"csis-tilt",children:e.jsx("img",{src:t,alt:o,className:"csis-hero",draggable:!1})}),!v&&e.jsxs("span",{className:"csis-hint",style:{color:f},children:[e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:e.jsx("path",{d:"M4 12h16M4 12l4-4M4 12l4 4M20 12l-4-4M20 12l-4 4"})}),"Drag to turn"]}),e.jsx("style",{children:`
        .csis {
          position: relative;
          width: 100%;
          height: 100%;
      ...
      `})]})}function $e({src:t,alt:o}){return e.jsxs("div",{className:"csps",children:[e.jsx("img",{src:t,alt:o,className:"csps-art",draggable:!1}),e.jsx("div",{className:"csps-vignette","aria-hidden":"true"}),e.jsx("style",{children:`
        .csps {
          position: relative;
          width: 100%;
          height: 100%;
      ...
      `})]})}function Ae(t){const o=document.body;for(let d=t.parentElement;d&&d!==o;d=d.parentElement){const f=getComputedStyle(d).overflowY;if(f==="auto"||f==="scroll")return d}return null}const Ye=t=>1-(1-t)*(1-t),We=t=>t<0?0:t>1?1:t;function Ve({data:t}){const o=j.useRef(null),d=j.useRef([]),[f,w]=j.useState(!1),[i,v]=j.useState(null),[A,k]=j.useState(null),E=i??A,s=t.map.pins.find(r=>r.key===E)??null,{canvas:p,layers:c}=t.parallax,[h,m]=p;j.useEffect(()=>{const r=o.current;if(!r||window.matchMedia("(prefers-reduced-motion: reduce)").matches||!window.matchMedia("(min-width: 768px)").matches)return;let b=!1;const S=new IntersectionObserver(([g])=>{if(!g.isIntersecting)return;S.disconnect();const n=()=>{b||w(!0)},u=(document.getAnimations?.()??[]).filter(N=>N.playState==="running"&&/^cs-(main|page)-in$/.test(N.animationName??""));u.length?Promise.allSettled(u.map(N=>N.finished)).then(n,n):n()},{root:Ae(r),rootMargin:"300px 0px"});return S.observe(r),()=>{b=!0,S.disconnect()}},[]),j.useEffect(()=>{if(!f)return;const r=o.current;if(!r)return;const b=Ae(r),S=performance.now();let g=S,n=0;const u=c.map(L=>L.intro[0]),N=L=>{const M=Math.min((L-g)/1e3,.1);g=L;const C=r.getBoundingClientRect(),I=b?b.clientHeight:window.innerHeight,V=b?C.top-b.getBoundingClientRect().top:C.top,_=We((I-V)/(I+C.height));for(let H=0;H<c.length;H++){const z=c[H],K=d.current[H];if(!K)continue;const D=(L-S)/1e3-z.delay;let B;if(D<z.dur){const O=D<=0?0:Ye(D/z.dur);B=z.intro[0]+(z.intro[1]-z.intro[0])*O,u[H]=B}else{const O=z.scrollTo===void 0?z.intro[1]:z.intro[1]+(z.scrollTo-z.intro[1])*_,$=z.scrub??0;u[H]=$>0?u[H]+(O-u[H])*(1-Math.exp(-M/$)):O,B=u[H]}K.style.transform=`translate3d(0, ${B.toFixed(3)}%, 0)`}n=requestAnimationFrame(N)},P=new IntersectionObserver(([L])=>{L.isIntersecting?n||(g=performance.now(),n=requestAnimationFrame(N)):n&&(cancelAnimationFrame(n),n=0)},{root:b,threshold:0});return P.observe(r),()=>{P.disconnect(),n&&cancelAnimationFrame(n)}},[f,c]);const[l,x]=t.map.canvas,T=(r,b)=>`${(r/b*100).toFixed(4)}%`;return e.jsxs("section",{className:"csm","aria-labelledby":"csm-head",children:[e.jsxs("div",{className:"cs-section-head",children:[e.jsx("p",{className:"cs-eyebrow",id:"csm-head",children:t.eyebrow}),e.jsx("p",{className:"cs-stage-note",children:t.note})]}),e.jsxs("div",{className:"csm-inner",children:[e.jsx("p",{className:"csm-lede",children:t.lede}),e.jsxs("figure",{className:"csm-fig",children:[e.jsx("div",{className:"csm-stage",ref:o,style:{aspectRatio:`${h} / ${m}`},"aria-hidden":"true",children:c.map((r,b)=>e.jsx("img",{ref:S=>{d.current[b]=S},className:"csm-layer",src:r.src,alt:"",loading:"lazy",decoding:"async",draggable:!1,style:{left:T(r.x,h),top:T(r.y,m),width:T(r.w,h),transform:`translate3d(0, ${r.intro[1]}%, 0)`}},r.key))}),e.jsx("figcaption",{className:"csm-cap",children:t.parallax.caption})]}),e.jsxs("figure",{className:"csm-fig",children:[e.jsxs("div",{className:"csm-map",style:{aspectRatio:`${l} / ${x}`},children:[e.jsx("img",{className:"csm-map-art",src:t.map.src,alt:t.map.alt,loading:"lazy",decoding:"async",draggable:!1}),t.map.pins.map(r=>e.jsx("button",{type:"button",className:"csm-pin","data-on":E===r.key?"":void 0,"aria-pressed":A===r.key,"aria-label":`${r.label} pin${r.unbuilt?", designed and never built":""}`,style:{left:T(r.x,l),top:T(r.y,x),width:T(r.w,l),height:T(r.h,x)},onMouseEnter:()=>v(r.key),onMouseLeave:()=>v(null),onFocus:()=>v(r.key),onBlur:()=>v(null),onClick:()=>k(b=>b===r.key?null:r.key),children:e.jsx("img",{className:"csm-pin-art",src:r.hover,alt:"",loading:"lazy",decoding:"async",draggable:!1})},r.key))]}),e.jsx("p",{className:"csm-readout","aria-live":"polite",children:s?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"csm-readout-k",children:s.label}),s.note]}):e.jsx("span",{className:"csm-readout-idle",children:t.map.idle})}),e.jsx("ul",{className:"csm-pinlist",children:t.map.pins.map(r=>e.jsxs("li",{className:"csm-row",children:[e.jsx("img",{className:"csm-pinlist-art",src:r.hover,alt:`${r.label} pin, hover state`,loading:"lazy",decoding:"async"}),e.jsx("span",{className:"csm-row-d",children:r.note})]},r.key))}),e.jsx("figcaption",{className:"csm-cap",children:t.map.caption}),e.jsx("p",{className:"csm-shipped",children:t.map.shipped})]}),e.jsxs("div",{className:"csm-block",children:[e.jsx("h3",{className:"cs-eyebrow",children:"Client direction"}),e.jsx("ul",{className:"csm-rows csm-rows-q",children:t.direction.map(r=>e.jsxs("li",{className:"csm-row csm-row-q",children:[e.jsx("blockquote",{className:"csm-q",children:r.quote}),e.jsxs("p",{className:"csm-attr",children:[r.author,e.jsx("span",{className:"csm-attr-date",children:r.date})]}),e.jsx("p",{className:"csm-out",children:r.outcome})]},r.quote))}),e.jsx("p",{className:"csm-foot",children:t.directionNote}),e.jsx("ul",{className:"csm-rows csm-rows-h",children:t.handoff.map(r=>e.jsxs("li",{className:"csm-row csm-row-h",children:[e.jsx("span",{className:"csm-hnote",children:r.note}),e.jsx("span",{className:"csm-row-d",children:r.detail})]},r.note))})]})]}),e.jsx("style",{children:`
      ...
      `})]})}const _e=48;function Ke({items:t,index:o,accent:d,onIndex:f,onClose:w}){const i=j.useRef(null),v=j.useRef(null),A=t[o],k=j.useCallback(s=>{t.length<2||f((o+s+t.length)%t.length)},[o,t.length,f]);if(j.useEffect(()=>{const s=p=>{p.key==="Escape"?(p.preventDefault(),p.stopPropagation(),w()):p.key==="ArrowRight"?k(1):p.key==="ArrowLeft"&&k(-1)};return window.addEventListener("keydown",s,!0),()=>window.removeEventListener("keydown",s,!0)},[k,w]),j.useEffect(()=>{const s=window.__lenis,p=s?.isStopped===!0;p||s?.stop?.();const c=document.documentElement,h=c.style.overflow,m=document.body.style.overflow;c.style.overflow="hidden",document.body.style.overflow="hidden";const l=document.querySelector(".cso-scroll"),x=l?.style.overflowY??null;return l&&(l.style.overflowY="hidden"),()=>{c.style.overflow=h,document.body.style.overflow=m,l&&(l.style.overflowY=x??""),p||s?.start?.()}},[]),j.useEffect(()=>{const s=document.activeElement;return i.current?.focus(),()=>s?.focus?.()},[]),!A)return null;const E=e.jsxs("div",{className:"csl",role:"dialog","aria-modal":"true","aria-label":`${A.alt}${t.length>1?`, image ${o+1} of ${t.length}`:""}`,style:{"--csl-accent":d},"data-lenis-prevent":!0,onClick:w,onTouchStart:s=>{const p=s.touches[0];v.current={x:p.clientX,y:p.clientY}},onTouchEnd:s=>{const p=v.current;if(v.current=null,!p)return;const c=s.changedTouches[0],h=c.clientX-p.x,m=c.clientY-p.y;Math.abs(h)>_e&&Math.abs(h)>Math.abs(m)*1.5&&k(h<0?1:-1)},children:[e.jsx("button",{ref:i,className:"csl-x",onClick:w,"aria-label":"Close image",children:e.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round","aria-hidden":"true",children:e.jsx("path",{d:"M5 5l14 14M19 5L5 19"})})}),t.length>1&&e.jsxs("span",{className:"csl-count","aria-hidden":"true",children:[String(o+1).padStart(2,"0")," / ",String(t.length).padStart(2,"0")]}),t.length>1&&e.jsxs(e.Fragment,{children:[e.jsx("button",{className:"csl-nav csl-prev","aria-label":"Previous image",onClick:s=>{s.stopPropagation(),k(-1)},children:e.jsx("svg",{width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:e.jsx("path",{d:"M15 5l-7 7 7 7"})})}),e.jsx("button",{className:"csl-nav csl-next","aria-label":"Next image",onClick:s=>{s.stopPropagation(),k(1)},children:e.jsx("svg",{width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:e.jsx("path",{d:"M9 5l7 7-7 7"})})})]}),e.jsxs("figure",{className:"csl-fig",onClick:s=>s.stopPropagation(),children:[e.jsx("img",{className:"csl-img",src:A.src,alt:A.alt,decoding:"async"},A.src),e.jsx("figcaption",{className:"csl-cap",children:A.caption??A.alt})]}),e.jsx("style",{children:`
        .csl {
          position: fixed;
          inset: 0;
          z-index: 400;
      ...
      `})]});return Pe.createPortal(E,document.body)}const Xe=t=>{const o=[];let d=[];for(const f of t)f.kind==="tile"?d.push(f):(d.length&&o.push({type:"grid",tiles:d}),d=[],o.push({type:"divider",divider:f}));return d.length&&o.push({type:"grid",tiles:d}),o},Ue=t=>{const o=t.col>=3?2:1,d=t.rowM??Math.max(2,Math.round(t.row*.75));return{"--c":t.col,"--r":t.row,"--cm":o,"--rm":d,...t.pos?{"--pos":t.pos}:{}}},Ze=t=>["cs-tile",`cs-tile-${t.tile??"plain"}`,`cs-pad-${t.pad??"std"}`,t.fit==="cover"?"cs-fit-cover":"cs-fit-contain"].join(" ");function Je({gallery:t,accent:o,glow:d,resetKey:f,eyebrow:w="The Work",standalone:i=!1}){const[v,A]=j.useState(null);j.useEffect(()=>A(null),[f]);const k=Xe(t),E=t.map(c=>c.kind==="tile"?{src:c.src,alt:c.alt,caption:c.caption}:{src:c.src,alt:c.alt}),s=new Map(E.map((c,h)=>[c.src,h])),p=i?{"--cs-accent":o,"--cs-glow":d??"transparent"}:void 0;return e.jsxs(e.Fragment,{children:[e.jsxs("section",{className:"cs-gallery","aria-label":"Project gallery",style:p,children:[w&&e.jsx("div",{className:"cs-section-head",children:e.jsx("p",{className:"cs-eyebrow",children:w})}),k.map((c,h)=>c.type==="grid"?e.jsx("div",{className:"cs-grid",children:c.tiles.map(m=>e.jsxs("figure",{className:Ze(m),style:Ue(m),children:[e.jsx("button",{type:"button",className:"cs-tile-open",onClick:()=>A(s.get(m.src)??0),children:e.jsx("img",{src:m.src,alt:m.alt,loading:"lazy",decoding:"async"})}),m.caption&&e.jsx("figcaption",{className:"cs-cap",children:m.caption})]},m.src))},h):e.jsx("div",{className:"cs-band",children:e.jsx("button",{type:"button",className:"cs-tile-open",onClick:()=>A(s.get(c.divider.src)??0),children:e.jsx("img",{src:c.divider.src,alt:c.divider.alt,loading:"lazy",decoding:"async"})})},h))]}),v!==null&&e.jsx(Ke,{items:E,index:v,accent:o,onIndex:A,onClose:()=>A(null)}),e.jsx("style",{children:`
        /* ═══ Gallery ═══ */
