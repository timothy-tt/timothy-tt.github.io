import{j as e}from"./jsx-runtime.D_zvdyIk.js";import{r}from"./index.DiEladB3.js";const g=["/strane-site/expo-team.webp","/strane-site/expo-outside.webp","/strane-site/expo-inside.webp","/hellavated-site/lifestyle-hero.webp","/garcia-site/hero-event.webp","/garcia-site/apparel-lifestyle.webp","/portfolio/dodrops/hi/dodrops-tarot-melon-lifestyle.webp"],S=7e3,u=2e3,E=.13,f={3:.55,4:.9,5:.8,6:.7},w={3:.35,6:.6},v="80px";function N(){const[s,a]=r.useState(!1);return r.useEffect(()=>{const o=window.matchMedia("(prefers-reduced-motion: reduce)");a(o.matches);const i=n=>a(n.matches);return o.addEventListener("change",i),()=>o.removeEventListener("change",i)},[]),s}function I({active:s}){const a=N(),[o,i]=r.useState({current:0,previous:-1});return r.useEffect(()=>{if(!s||a)return;const n=window.setInterval(()=>{i(t=>({current:(t.current+1)%g.length,previous:t.current}))},S+u);return()=>window.clearInterval(n)},[s,a]),e.jsx("div",{className:"absolute inset-0 z-0 pointer-events-none","aria-hidden":"true",style:{opacity:E,WebkitMaskImage:`linear-gradient(to bottom, transparent 0, #000 ${v})`,maskImage:`linear-gradient(to bottom, transparent 0, #000 ${v})`},children:g.map((n,t)=>e.jsx("img",{src:n,alt:"",className:"absolute inset-0 w-full h-full object-cover object-center",style:{opacity:t===o.current||t===o.previous?1:0,zIndex:t===o.current?2:t===o.previous?1:0,filter:[f[t]?`brightness(${f[t]})`:"",w[t]?`saturate(${w[t]})`:""].filter(Boolean).join(" ")||void 0,transition:a?"none":`opacity ${u}ms linear`},loading:t===0?"eager":"lazy",decoding:"async"},n))})}const R=[{name:"BETTER",logo:"/brand-logo/better.png"},{name:"HELLAVATED",logo:"/brand-logo/hellavated.png"},{name:"DO DROPS",logo:"/brand-logo/dodrops.png"},{name:"STRANE",logo:"/brand-logo/strane.png"},{name:"GHP",logo:"/brand-logo/ghp-wordmark.png"}],T=[{name:"DOUGIE",logo:"/brand-logo/dougie.png"},{name:"AVITAS",logo:"/brand-logo/avitas-wordmark.png"},{name:"LOOT BAR",logo:"/brand-logo/loot-bar.png"},{name:"HOLISTIC INDUSTRIES",logo:"/brand-logo/holistic-industries.png"},{name:"SUNNY JAYS",logo:"/brand-logo/sunny-jays.png"}];function z({name:s,logo:a,muted:o}){return e.jsx("div",{className:`oc-pill flex-shrink-0 flex items-center justify-center px-5 py-3 md:px-8 md:py-4
        ...
        /* Reading a name is worth more than the motion; the strip holds still
           while a pointer is on it. Real pointers only: iOS keeps :hover on
           whatever was last tapped, so without the gate one tap on the strip
           froze the marquee until the next. */
        @media (hover: hover) {
        ...
        /* Same gate as the pause above: a tapped pill would otherwise stay
           lit until the next tap. */
        @media (hover: hover) {
          .oc-pill:hover {
