...
import{j as e}from"./jsx-runtime.D_zvdyIk.js";import{r as S}from"./index.DiEladB3.js";import{_ as ae}from"./preload-helper.BlTxHScW.js";import{r as He}from"./index.Pl_XcmgS.js";function ve(i){const n=document.body;for(let p=i.parentElement;p&&p!==n;p=p.parentElement){const j=getComputedStyle(p).overflowY;if(j==="auto"||j==="scroll")return p}return null}const Pe=.06,ye=.0085,De=.006,Z=1.45,Be=8;function Re({modelUrl:i,poster:n,posterAlt:p,accent:j,yaw:z=0,exposure:r=1,orient:y}){const b=S.useRef(null),[T,L]=S.useState(!1),[c,w]=S.useState("poster"),[a,g]=S.useState(!1);S.useEffect(()=>{if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const s=b.current;if(!s)return;let f=!1;const M=()=>{f||L(!0)},o=()=>{const h=window;h.requestIdleCallback?h.requestIdleCallback(M,{timeout:1200}):window.setTimeout(M,200)},v=()=>{const h=(document.getAnimations?.()??[]).filter(d=>d.playState==="running"&&/^cs-(main|page)-in$/.test(d.animationName??""));h.length?Promise.allSettled(h.map(d=>d.finished)).then(o,o):o()},x=new IntersectionObserver(([h])=>{h.isIntersecting&&(x.disconnect(),v())},{root:ve(s),rootMargin:"400px 0px"});return x.observe(s),()=>{f=!0,x.disconnect()}},[]),S.useEffect(()=>{if(!T)return;const s=b.current;if(!s)return;let f=!1,M=null;return(async()=>{const[o,{GLTFLoader:v},{RoomEnvironment:x}]=await Promise.all([ae(()=>import("./three.module.Bx43vjkH.js"),[]),ae(()=>import("./GLTFLoader.BqdKpcjx.js"),__vite__mapDeps([0,1])),ae(()=>import("./RoomEnvironment.Ct7rVCVU.js"),__vite__mapDeps([2,1]))]);if(f)return;let h;try{if(h=new o.WebGLRenderer({antialias:!0,alpha:!0}),!h.getContext())throw new Error("no webgl context")}catch(k){console.warn("CaseStudyStage: WebGL unavailable, keeping poster",k),w("failed");return}h.setPixelRatio(Math.min(window.devicePixelRatio,2)),h.toneMapping=o.ACESFilmicToneMapping,h.toneMappingExposure=.82*r,h.outputColorSpace=o.SRGBColorSpace,h.setSize(s.clientWidth,s.clientHeight),s.appendChild(h.domElement);const d=h.domElement;d.style.width="100%",d.style.height="100%",d.style.display="block",d.style.touchAction="pan-y";const E=new o.Scene,N=new o.PerspectiveCamera(38,s.clientWidth/s.clientHeight,.1,100);N.position.set(0,0,5.4);const D=new o.PMREMGenerator(h),m=D.fromScene(new x,.04).texture;E.environment=m,E.environmentIntensity=.55;const l=new o.Color(j),A=l.clone().lerp(new o.Color("#ffffff"),.55),P=new o.DirectionalLight(16777215,.5);P.position.set(0,3,5);const $=new o.DirectionalLight(l,1);$.position.set(-5,1.5,-3.5);const V=new o.DirectionalLight(A,.7);V.position.set(4.5,2,3),E.add(P,$,V);const H=new o.Group,C=new o.Group;C.rotation.y=z,H.add(C),E.add(H);const X=(k,q)=>{const I=new o.Box3().setFromObject(k),G=I.getSize(new o.Vector3),U=I.getCenter(new o.Vector3),Ce=Math.max(G.x,G.y,G.z)||1,we=q/Ce;k.scale.setScalar(we),k.position.copy(U).multiplyScalar(-we)};new v().load(i,k=>{if(f)return;const q=k.scene,I=new o.Group;y&&I.rotation.set(y[0],y[1],y[2]),I.add(q),X(I,2.8);const G=()=>{f||(C.add(I),w("ready"))};h.compileAsync(I,N,E).then(G,G)},void 0,k=>{console.warn("CaseStudyStage: GLB failed to load, keeping poster",k),w("failed")});let B=!1,R=!1,O=0,Y=0,ie=0,se=0,F=0;const Ee=k=>k<-Z?-Z:k>Z?Z:k,ne=k=>{k.pointerType==="mouse"&&k.button!==0||(B=!0,R=k.pointerType!=="touch",O=ie=k.clientX,Y=se=k.clientY,F=0,R&&d.setPointerCapture?.(k.pointerId),g(!0))},le=k=>{if(!B)return;if(!R){const G=k.clientX-ie,U=k.clientY-se;if(Math.hypot(G,U)<Be)return;if(Math.abs(G)<=Math.abs(U)){B=!1,g(!1);return}R=!0,d.setPointerCapture?.(k.pointerId)}const q=k.clientX-O,I=k.clientY-Y;O=k.clientX,Y=k.clientY,C.rotation.y+=q*ye,H.rotation.x=Ee(H.rotation.x+I*De),F=F*.6+q*ye*.4},K=()=>{B&&(B=!1,R=!1,g(!1))};d.addEventListener("pointerdown",ne),d.addEventListener("pointermove",le),d.addEventListener("pointerup",K),d.addEventListener("pointercancel",K);let W=!1;const ce=k=>{k.pointerType==="mouse"&&(W=!0)},de=()=>{W=!1};s.addEventListener("pointerenter",ce),s.addEventListener("pointerleave",de);const he=new o.Clock;let J=0,Q=!1;const Ne=()=>{const k=Math.min(he.getDelta(),.05);if(!B){const q=W?0:Pe*k;F+=(q-F)*(W?.09:.03),W&&Math.abs(F)<1e-5&&(F=0),C.rotation.y+=F}h.render(E,N)},pe=()=>{Ne(),J=requestAnimationFrame(pe)},ze=()=>{Q||(Q=!0,he.start(),J=requestAnimationFrame(pe))},me=()=>{Q=!1,cancelAnimationFrame(J)};let ge=!0;const ee=()=>{ge&&!document.hidden?ze():me()},ue=new IntersectionObserver(([k])=>{ge=k.isIntersecting,ee()},{root:ve(s),threshold:0});ue.observe(s);const fe=()=>ee();document.addEventListener("visibilitychange",fe);const te=()=>{!s.clientWidth||!s.clientHeight||(N.aspect=s.clientWidth/s.clientHeight,N.updateProjectionMatrix(),h.setSize(s.clientWidth,s.clientHeight))};window.addEventListener("resize",te);const be=new ResizeObserver(te);be.observe(s),ee(),M=()=>{me(),ue.disconnect(),be.disconnect(),document.removeEventListener("visibilitychange",fe),window.removeEventListener("resize",te),d.removeEventListener("pointerdown",ne),d.removeEventListener("pointermove",le),d.removeEventListener("pointerup",K),d.removeEventListener("pointercancel",K),s.removeEventListener("pointerenter",ce),s.removeEventListener("pointerleave",de),m.dispose(),D.dispose(),h.dispose(),d.parentNode===s&&s.removeChild(d)}})(),()=>{f=!0,M?.()}},[T,i,j,z,r,y]);const u=c!=="ready";return e.jsxs("div",{className:"cs-stage",style:{cursor:c==="ready"?a?"grabbing":"grab":"default"},children:[e.jsx("div",{ref:b,className:"cs-stage-mount","aria-hidden":c==="ready"?void 0:!0}),e.jsx("img",{src:n,alt:p,draggable:!1,className:"cs-stage-poster",style:{opacity:u?1:0},loading:"lazy"}),c==="ready"&&e.jsxs("span",{className:"cs-stage-hint",style:{color:j},children:[e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:e.jsx("path",{d:"M12 4v16M4 12h16M12 4l-3 3M12 4l3 3M12 20l-3-3M12 20l3-3M4 12l3-3M4 12l3 3M20 12l-3-3M20 12l-3 3"})}),"Drag to rotate"]}),e.jsx("style",{children:`
        .cs-stage {
          position: relative;
          width: 100%;
          height: 100%;
      ...
      `})]})}const Ie=.26,Ge=.2,ke=30,xe=17,je=.93,Oe=.045,Te=3;function Fe({hero:i,heroAlt:n,backdrop:p,accent:j}){const z=S.useRef(null),r=S.useRef(null),[y,b]=S.useState(!1);return S.useEffect(()=>{const T=z.current,L=r.current;if(!T||!L)return;const c=window.matchMedia("(prefers-reduced-motion: reduce)").matches;let w=0,a=0,g=0,u=0,s=!1,f=!1,M=0,o=0,v=0;const x=(l,A)=>l<-A?-A:l>A?A:l,h=()=>{L.style.transform=`perspective(1100px) rotateX(${a.toFixed(3)}deg) rotateY(${w.toFixed(3)}deg)`},d=()=>{if(v=0,s)return;if(Math.abs(g)>.05||Math.abs(u)>.05)w=x(w+g,ke),a=x(a+u,xe),g*=je,u*=je;else{g=0,u=0;const A=c?.25:Oe;if(w+=(0-w)*A,a+=(0-a)*A,Math.abs(w)<.04&&Math.abs(a)<.04){w=0,a=0,h();return}}h(),v=requestAnimationFrame(d)},E=()=>{!v&&!s&&(v=requestAnimationFrame(d))},N=l=>{l.pointerType==="mouse"&&l.button!==0||(f=!0,s=!1,M=l.clientX,o=l.clientY,g=0,u=0,v&&(cancelAnimationFrame(v),v=0))},D=l=>{if(!f)return;const A=l.clientX-M,P=l.clientY-o;if(!s){if(Math.abs(A)<Te&&Math.abs(P)<Te)return;if(l.pointerType!=="mouse"&&Math.abs(P)>Math.abs(A)){f=!1;return}s=!0,b(!0),T.classList.add("csis-dragging"),T.setPointerCapture?.(l.pointerId)}M=l.clientX,o=l.clientY,g=A*Ie,u=P*Ge,w=x(w+g,ke),a=x(a+u,xe),h()},m=l=>{!f&&!s||(f=!1,s&&(s=!1,T.classList.remove("csis-dragging"),T.releasePointerCapture?.(l.pointerId),c&&(g=0,u=0)),E())};return T.addEventListener("pointerdown",N),T.addEventListener("pointermove",D),T.addEventListener("pointerup",m),T.addEventListener("pointercancel",m),()=>{T.removeEventListener("pointerdown",N),T.removeEventListener("pointermove",D),T.removeEventListener("pointerup",m),T.removeEventListener("pointercancel",m),v&&cancelAnimationFrame(v)}},[]),e.jsxs("div",{ref:z,className:"csis",children:[e.jsx("img",{src:p,alt:"","aria-hidden":"true",className:"csis-backdrop",draggable:!1}),e.jsx("div",{className:"csis-scrim","aria-hidden":"true"}),e.jsx("div",{ref:r,className:"csis-tilt",children:e.jsx("img",{src:i,alt:n,className:"csis-hero",draggable:!1})}),!y&&e.jsxs("span",{className:"csis-hint",style:{color:j},children:[e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:e.jsx("path",{d:"M4 12h16M4 12l4-4M4 12l4 4M20 12l-4-4M20 12l-4 4"})}),"Drag to turn"]}),e.jsx("style",{children:`
        .csis {
          position: relative;
          width: 100%;
          height: 100%;
      ...
      `})]})}function Se(i){const n=document.body;for(let p=i.parentElement;p&&p!==n;p=p.parentElement){const j=getComputedStyle(p).overflowY;if(j==="auto"||j==="scroll")return p}return null}const $e=i=>1-(1-i)*(1-i),Ye=i=>i<0?0:i>1?1:i;function We({data:i}){const n=S.useRef(null),p=S.useRef([]),[j,z]=S.useState(!1),[r,y]=S.useState(null),[b,T]=S.useState(null),L=r??b,c=i.map.pins.find(o=>o.key===L)??null,{canvas:w,layers:a}=i.parallax,[g,u]=w;S.useEffect(()=>{const o=n.current;if(!o||window.matchMedia("(prefers-reduced-motion: reduce)").matches||!window.matchMedia("(min-width: 768px)").matches)return;let v=!1;const x=new IntersectionObserver(([h])=>{if(!h.isIntersecting)return;x.disconnect();const d=()=>{v||z(!0)},E=(document.getAnimations?.()??[]).filter(N=>N.playState==="running"&&/^cs-(main|page)-in$/.test(N.animationName??""));E.length?Promise.allSettled(E.map(N=>N.finished)).then(d,d):d()},{root:Se(o),rootMargin:"300px 0px"});return x.observe(o),()=>{v=!0,x.disconnect()}},[]),S.useEffect(()=>{if(!j)return;const o=n.current;if(!o)return;const v=Se(o),x=performance.now();let h=x,d=0;const E=a.map(m=>m.intro[0]),N=m=>{const l=Math.min((m-h)/1e3,.1);h=m;const A=o.getBoundingClientRect(),P=v?v.clientHeight:window.innerHeight,$=v?A.top-v.getBoundingClientRect().top:A.top,V=Ye((P-$)/(P+A.height));for(let H=0;H<a.length;H++){const C=a[H],X=p.current[H];if(!X)continue;const B=(m-x)/1e3-C.delay;let R;if(B<C.dur){const O=B<=0?0:$e(B/C.dur);R=C.intro[0]+(C.intro[1]-C.intro[0])*O,E[H]=R}else{const O=C.scrollTo===void 0?C.intro[1]:C.intro[1]+(C.scrollTo-C.intro[1])*V,Y=C.scrub??0;E[H]=Y>0?E[H]+(O-E[H])*(1-Math.exp(-l/Y)):O,R=E[H]}X.style.transform=`translate3d(0, ${R.toFixed(3)}%, 0)`}d=requestAnimationFrame(N)},D=new IntersectionObserver(([m])=>{m.isIntersecting?d||(h=performance.now(),d=requestAnimationFrame(N)):d&&(cancelAnimationFrame(d),d=0)},{root:v,threshold:0});return D.observe(o),()=>{D.disconnect(),d&&cancelAnimationFrame(d)}},[j,a]);const[s,f]=i.map.canvas,M=(o,v)=>`${(o/v*100).toFixed(4)}%`;return e.jsxs("section",{className:"csm","aria-labelledby":"csm-head",children:[e.jsxs("div",{className:"cs-section-head",children:[e.jsx("p",{className:"cs-eyebrow",id:"csm-head",children:i.eyebrow}),e.jsx("p",{className:"cs-stage-note",children:i.note})]}),e.jsxs("div",{className:"csm-inner",children:[e.jsx("p",{className:"csm-lede",children:i.lede}),e.jsxs("figure",{className:"csm-fig",children:[e.jsx("div",{className:"csm-stage",ref:n,style:{aspectRatio:`${g} / ${u}`},"aria-hidden":"true",children:a.map((o,v)=>e.jsx("img",{ref:x=>{p.current[v]=x},className:"csm-layer",src:o.src,alt:"",loading:"lazy",decoding:"async",draggable:!1,style:{left:M(o.x,g),top:M(o.y,u),width:M(o.w,g),transform:`translate3d(0, ${o.intro[1]}%, 0)`}},o.key))}),e.jsx("figcaption",{className:"csm-cap",children:i.parallax.caption})]}),e.jsxs("figure",{className:"csm-fig",children:[e.jsxs("div",{className:"csm-map",style:{aspectRatio:`${s} / ${f}`},children:[e.jsx("img",{className:"csm-map-art",src:i.map.src,alt:i.map.alt,loading:"lazy",decoding:"async",draggable:!1}),i.map.pins.map(o=>e.jsx("button",{type:"button",className:"csm-pin","data-on":L===o.key?"":void 0,"aria-pressed":b===o.key,"aria-label":`${o.label} pin${o.unbuilt?", designed and never built":""}`,style:{left:M(o.x,s),top:M(o.y,f),width:M(o.w,s),height:M(o.h,f)},onMouseEnter:()=>y(o.key),onMouseLeave:()=>y(null),onFocus:()=>y(o.key),onBlur:()=>y(null),onClick:()=>T(v=>v===o.key?null:o.key),children:e.jsx("img",{className:"csm-pin-art",src:o.hover,alt:"",loading:"lazy",decoding:"async",draggable:!1})},o.key))]}),e.jsx("p",{className:"csm-readout","aria-live":"polite",children:c?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"csm-readout-k",children:c.label}),c.note]}):e.jsx("span",{className:"csm-readout-idle",children:i.map.idle})}),e.jsx("ul",{className:"csm-pinlist",children:i.map.pins.map(o=>e.jsxs("li",{className:"csm-row",children:[e.jsx("img",{className:"csm-pinlist-art",src:o.hover,alt:`${o.label} pin, hover state`,loading:"lazy",decoding:"async"}),e.jsx("span",{className:"csm-row-d",children:o.note})]},o.key))}),e.jsx("figcaption",{className:"csm-cap",children:i.map.caption}),e.jsx("p",{className:"csm-shipped",children:i.map.shipped})]}),e.jsxs("div",{className:"csm-block",children:[e.jsx("h3",{className:"cs-eyebrow",children:"Client direction"}),e.jsx("ul",{className:"csm-rows csm-rows-q",children:i.direction.map(o=>e.jsxs("li",{className:"csm-row csm-row-q",children:[e.jsx("blockquote",{className:"csm-q",children:o.quote}),e.jsxs("p",{className:"csm-attr",children:[o.author,e.jsx("span",{className:"csm-attr-date",children:o.date})]}),e.jsx("p",{className:"csm-out",children:o.outcome})]},o.quote))}),e.jsx("p",{className:"csm-foot",children:i.directionNote}),e.jsx("ul",{className:"csm-rows csm-rows-h",children:i.handoff.map(o=>e.jsxs("li",{className:"csm-row csm-row-h",children:[e.jsx("span",{className:"csm-hnote",children:o.note}),e.jsx("span",{className:"csm-row-d",children:o.detail})]},o.note))})]})]}),e.jsx("style",{children:`
      ...
      `})]})}const _e=48;function Ve({items:i,index:n,accent:p,onIndex:j,onClose:z}){const r=S.useRef(null),y=S.useRef(null),b=i[n],T=S.useCallback(c=>{i.length<2||j((n+c+i.length)%i.length)},[n,i.length,j]);if(S.useEffect(()=>{const c=w=>{w.key==="Escape"?(w.preventDefault(),w.stopPropagation(),z()):w.key==="ArrowRight"?T(1):w.key==="ArrowLeft"&&T(-1)};return window.addEventListener("keydown",c,!0),()=>window.removeEventListener("keydown",c,!0)},[T,z]),S.useEffect(()=>{const c=window.__lenis,w=c?.isStopped===!0;w||c?.stop?.();const a=document.documentElement,g=a.style.overflow,u=document.body.style.overflow;a.style.overflow="hidden",document.body.style.overflow="hidden";const s=document.querySelector(".cso-scroll"),f=s?.style.overflowY??null;return s&&(s.style.overflowY="hidden"),()=>{a.style.overflow=g,document.body.style.overflow=u,s&&(s.style.overflowY=f??""),w||c?.start?.()}},[]),S.useEffect(()=>{const c=document.activeElement;return r.current?.focus(),()=>c?.focus?.()},[]),!b)return null;const L=e.jsxs("div",{className:"csl",role:"dialog","aria-modal":"true","aria-label":`${b.alt}${i.length>1?`, image ${n+1} of ${i.length}`:""}`,style:{"--csl-accent":p},"data-lenis-prevent":!0,onClick:z,onTouchStart:c=>{const w=c.touches[0];y.current={x:w.clientX,y:w.clientY}},onTouchEnd:c=>{const w=y.current;if(y.current=null,!w)return;const a=c.changedTouches[0],g=a.clientX-w.x,u=a.clientY-w.y;Math.abs(g)>_e&&Math.abs(g)>Math.abs(u)*1.5&&T(g<0?1:-1)},children:[e.jsx("button",{ref:r,className:"csl-x",onClick:z,"aria-label":"Close image",children:e.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round","aria-hidden":"true",children:e.jsx("path",{d:"M5 5l14 14M19 5L5 19"})})}),i.length>1&&e.jsxs("span",{className:"csl-count","aria-hidden":"true",children:[String(n+1).padStart(2,"0")," / ",String(i.length).padStart(2,"0")]}),i.length>1&&e.jsxs(e.Fragment,{children:[e.jsx("button",{className:"csl-nav csl-prev","aria-label":"Previous image",onClick:c=>{c.stopPropagation(),T(-1)},children:e.jsx("svg",{width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:e.jsx("path",{d:"M15 5l-7 7 7 7"})})}),e.jsx("button",{className:"csl-nav csl-next","aria-label":"Next image",onClick:c=>{c.stopPropagation(),T(1)},children:e.jsx("svg",{width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:e.jsx("path",{d:"M9 5l7 7-7 7"})})})]}),e.jsxs("figure",{className:"csl-fig",onClick:c=>c.stopPropagation(),children:[e.jsx("img",{className:"csl-img",src:b.src,alt:b.alt,decoding:"async"},b.src),e.jsx("figcaption",{className:"csl-cap",children:b.caption??b.alt})]}),e.jsx("style",{children:`
        .csl {
          position: fixed;
          inset: 0;
          z-index: 400;
      ...
      `})]});return He.createPortal(L,document.body)}const Xe=i=>{const n=[];let p=[];for(const j of i)j.kind==="tile"?p.push(j):(p.length&&n.push({type:"grid",tiles:p}),p=[],n.push({type:"divider",divider:j}));return p.length&&n.push({type:"grid",tiles:p}),n},Ke=i=>{const n=i.col>=3?2:1,p=i.rowM??Math.max(2,Math.round(i.row*.75));return{"--c":i.col,"--r":i.row,"--cm":n,"--rm":p,...i.pos?{"--pos":i.pos}:{}}},Ue=i=>["cs-tile",`cs-tile-${i.tile??"plain"}`,`cs-pad-${i.pad??"std"}`,i.fit==="cover"?"cs-fit-cover":"cs-fit-contain"].join(" ");function Ze({gallery:i,accent:n,glow:p,resetKey:j,eyebrow:z="The Work",standalone:r=!1}){const[y,b]=S.useState(null);S.useEffect(()=>b(null),[j]);const T=Xe(i),L=i.map(a=>a.kind==="tile"?{src:a.src,alt:a.alt,caption:a.caption}:{src:a.src,alt:a.alt}),c=new Map(L.map((a,g)=>[a.src,g])),w=r?{"--cs-accent":n,"--cs-glow":p??"transparent"}:void 0;return e.jsxs(e.Fragment,{children:[e.jsxs("section",{className:"cs-gallery","aria-label":"Project gallery",style:w,children:[z&&e.jsx("div",{className:"cs-section-head",children:e.jsx("p",{className:"cs-eyebrow",children:z})}),T.map((a,g)=>a.type==="grid"?e.jsx("div",{className:"cs-grid",children:a.tiles.map(u=>e.jsxs("figure",{className:Ue(u),style:Ke(u),children:[e.jsx("button",{type:"button",className:"cs-tile-open",onClick:()=>b(c.get(u.src)??0),children:e.jsx("img",{src:u.src,alt:u.alt,loading:"lazy",decoding:"async"})}),u.caption&&e.jsx("figcaption",{className:"cs-cap",children:u.caption})]},u.src))},g):e.jsx("div",{className:"cs-band",children:e.jsx("button",{type:"button",className:"cs-tile-open",onClick:()=>b(c.get(a.divider.src)??0),children:e.jsx("img",{src:a.divider.src,alt:a.divider.alt,loading:"lazy",decoding:"async"})})},g))]}),y!==null&&e.jsx(Ve,{items:L,index:y,accent:n,onIndex:b,onClose:()=>b(null)}),e.jsx("style",{children:`
        /* ═══ Gallery ═══ */
